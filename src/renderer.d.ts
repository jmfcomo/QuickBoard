...
declare global {
  interface Window {
    quickboard?: {
      ...
      onThemeChanged: (handler: (theme: 'system' | 'light' | 'sepia' | 'dark' | 'black') => void) => () => void;
      getThemeSource: () => Promise<'system' | 'light' | 'sepia' | 'dark' | 'black'>;
      setCustomTheme: (theme: 'sepia' | 'dark' | 'black' | null) => void;
